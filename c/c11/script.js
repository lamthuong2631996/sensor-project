...
same as the listeners in our previous chapters. The only
difference being that the value
* of the data being read has to be accessed through the "val"
getter method,
...
/**
* Similarly, we add the corresponding references and listeners for
humidity
*/
